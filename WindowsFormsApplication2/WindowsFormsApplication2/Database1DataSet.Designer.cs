...
namespace WindowsFormsApplication2 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class contactsDataTable : global::System.Data.TypedTableBase<contactsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public contactsRow AddcontactsRow(string firstname, string lastname, string email, int phonenumber) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public contactsRow FindByaddressid(int addressid) {
        ...
        public partial class contactsRow : global::System.Data.DataRow {
            ...
            public int addressid {
                get {
                    return ((int)(this[this.tablecontacts.addressidColumn]));
                }
                set {
                    this[this.tablecontacts.addressidColumn] = value;
                }
            }
            ...
            public int phonenumber {
                get {
                    return ((int)(this[this.tablecontacts.phonenumberColumn]));
                }
                set {
...
namespace WindowsFormsApplication2.Database1DataSetTableAdapters {
    ...
    public partial class contactsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[contacts] WHERE (([addressid] = @Original_addressid) AND ([fir" +
                "stname] = @Original_firstname) AND ([lastname] = @Original_lastname) AND ([phone" +
                "number] = @Original_phonenumber))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[contacts] ([firstname], [lastname], [email], [phonenumber]) VA" +
                "LUES (@firstname, @lastname, @email, @phonenumber);\r\nSELECT addressid, firstname" +
                ", lastname, email, phonenumber FROM contacts WHERE (addressid = SCOPE_IDENTITY()" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[contacts] SET [firstname] = @firstname, [lastname] = @lastname, [email] = @email, [phonenumber] = @phonenumber WHERE (([addressid] = @Original_addressid) AND ([firstname] = @Original_firstname) AND ([lastname] = @Original_lastname) AND ([phonenumber] = @Original_phonenumber));
SELECT addressid, firstname, lastname, email, phonenumber FROM contacts WHERE (addressid = @addressid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT addressid, firstname, lastname, email, phonenumber FROM dbo.contacts";
        ...
        public virtual int Delete(int Original_addressid, string Original_firstname, string Original_lastname, int Original_phonenumber) {
        ...
        public virtual int Insert(string firstname, string lastname, string email, int phonenumber) {
            if ((firstname == null)) {
        ...
        public virtual int Update(string firstname, string lastname, string email, int phonenumber, int Original_addressid, string Original_firstname, string Original_lastname, int Original_phonenumber, int addressid) {
            if ((firstname == null)) {
                throw new global::System.ArgumentNullException("firstname");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstname, string lastname, string email, int phonenumber, int Original_addressid, string Original_firstname, string Original_lastname, int Original_phonenumber) {
            return this.Update(firstname, lastname, email, phonenumber, Original_addressid, Original_firstname, Original_lastname, Original_phonenumber, Original_addressid);
        }
    }
